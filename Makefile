...
#    Updated: 2017/01/20 20:41:15 by smifsud          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
PRINTF = libftprintf.a
P1 = resources/players/filler
...
FILENAMES += ft_memcat.c ft_utf8.c
...
DIR3 = bot
FILENAMES3 = globals.c mapreader.c phil.c player1.c pieceplacer.c
INCLUDE = includes/
...
$(P1): $(OBJS3) $(NAME) | $(PLAYER1)
	gcc $(OBJS3) $(NAME) $(GNL) -o $@ $(CFLAGS) -I $(INCLUDE)
